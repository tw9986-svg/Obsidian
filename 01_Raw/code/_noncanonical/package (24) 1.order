...
model PumpCoastdown1D_R1
  "PumpCoastdown1D_RotorDynamics with the R1 operating-point hydraulic torque"
  extends MSRE.Experiments.PumpCoastdown1D_RotorDynamics(msre(pump(use_operatingPointTorque=true)));
  annotation (Documentation(info="<html>
<p>Identical to
<a href=\"modelica://MSRE.Experiments.PumpCoastdown1D_RotorDynamics\">PumpCoastdown1D_RotorDynamics</a>
